locals {
  ...
  auth_settings_v2 = var.auth_settings != null ? {
    ...
    identity_providers = {
      azure_active_directory = merge(
        {
          enabled = var.auth_settings.active_directory != null && var.auth_settings.active_directory.enabled
        },
        (var.auth_settings.active_directory != null && var.auth_settings.active_directory.enabled) ? {
          registration = {
